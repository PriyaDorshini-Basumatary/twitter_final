...
while True:
    user = api.get_user('Darshini_here31')
    api.update_profile(name=f'Priya DarshiNi|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Priya DarshiNi|{follower_count(user)} Followers')
